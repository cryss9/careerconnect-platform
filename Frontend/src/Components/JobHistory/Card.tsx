...
const Card = (props: any) => {
    ...
    return <div className="p-4 rounded-xl bg-mine-shaft-900   hover:shadow-[0_0_5px_1px_#4682B4] !shadow-bright-sun-400  transition duration-300 ease-in-out w-72 flex flex-col gap-3">
